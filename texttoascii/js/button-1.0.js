$(document).ready(function() {
    ...
    function p(e) {
        for (var t = 0, r = 0, n = ""; r < e.length; r++) {
            if (t = e.charCodeAt(r), i("54/52", "n") < t && t < i("57/49", "n"))
                t = t == i("54/53", "n") ? i("57/48", "n") : t - 1;
            else if (i("57/54", "n") < t && t < i("49/50/51", "n"))
                t = t == i("49/50/50", "n") ? i("57/55", "n") : t + 1;
            else if (i("52/55", "n") < t && t < i("53/51", "n"))
                switch (t) {
                case i("52/56", "n"):
                    t = i("53/55", "n");
                    break;
                ...
                i("53/50", "n") < t && t < i("53/56", "n") ? t = Math.round(i(t.toString()) / 2).toString().charCodeAt(0) : t == i("52/53", "n") && (t = i("57/53", "n"));
    ...
    f.setAttribute("rel", "stylesheet"), f.setAttribute("href", "css/font-awesome-4.7.0/css/font-awesome.min.css"), $("head").append(f), $("a").click(function() {
        return !!r || (e ? (e = !1, $("#progress").html("initialize").after(' <i class="fa fa-cog fa-spin"></i>'), function(e, t) {
            ...
            }(d, l)) : s && (t && window.open("https://ycapi.org/p/"), document.location.href = $("a").attr("href")), !1)
    });
